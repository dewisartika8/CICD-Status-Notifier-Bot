...
func NewBuildEvent(
	...
	eventType EventType,
	status BuildStatus,
	branch, commitSHA, commitMessage, authorName, authorEmail, buildURL string,
	webhookPayload json.RawMessage,
) (*BuildEvent, error) {
...
// RestoreBuildEvent restores a build event from persistence
func RestoreBuildEvent(
	id, projectID value_objects.ID,
	eventType EventType,
	status BuildStatus,
	branch, commitSHA, commitMessage, authorName, authorEmail, buildURL string,
	durationSeconds *int,
